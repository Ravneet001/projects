...
//for testing --create('directory name to test', 'file name to test', {data to test in json format}, callback function);

// _data.create('test', 'myFile',{ 'foo' : 'bar'}, function(err){
//     console.log('this was an error ', err);    
// } );

//testing for reading of data
// _data.read('test', 'myFile', function(err, data){
//     console.log('this was an error ', err + ' and the data is ' , data);    
// } );


//testing for updation of the file
// _data.update('test', 'myFile', {'ravneet':'gym girl'}, function(err){
//     console.log('this was an error ', err );    
// } );
...
httpsServer.listen(config.httpsPort, function() {
    console.log('server is listening on port '+ config.httpsPort +' and environment variable name is '+ config.envName);
});
